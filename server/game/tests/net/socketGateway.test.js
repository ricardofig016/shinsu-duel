...
const legalSlugs = () => createLegalDeck().map((cardId) => slugByCardId.get(cardId));
const slugToCardId = (slugs) => slugs.map((slug) => buildSlugIndex(cards).get(slug).cardId);
const unreachableSlug = () =>
