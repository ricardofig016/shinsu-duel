 ...
 * then ordering: `fixedSortKey ?? sortKey` picks a standard `sortCards` key.
 */
export function planGrid(views, { criteria = null, sortKey = null, fixedSortKey = null, predicate = null } = {}) {
