...
do not be afraid to ask me questions. im here for them. do not suppose anything nor guess, ask me. if anything is unclear at all, ask me. make your questions and options verbose, always include an open answer. for every question, i want to know what everything means, which option you recommend, and i want everything well explained. verbose.
