...
- [Plan: Project Resurrection - Comprehensive Rebuild Plan](#plan-project-resurrection---comprehensive-rebuild-plan)
- [Progress Tracker](#progress-tracker)
- [Phase 0: Foundation \& Data Pipeline](#phase-0-foundation--data-pipeline)
  - [Tracker](#tracker)
  - [What Changes](#what-changes)
  - [Design Note: Shinheuh Position Model](#design-note-shinheuh-position-model)
  - [Data Integrity \& Source of Truth](#data-integrity--source-of-truth)
  - [New Card Schema (YAML + Compiled JSON)](#new-card-schema-yaml--compiled-json)
  - [The "Scalable Complexity" Problem (Critical Design Decision)](#the-scalable-complexity-problem-critical-design-decision)
  - [Compiler Scope \& Boundaries (What It Actually Does)](#compiler-scope--boundaries-what-it-actually-does)
  - [Update Steps Phase 0](#update-steps-phase-0)
- [Phase 1: EventBus Redesign](#phase-1-eventbus-redesign)
  - [Tracker](#tracker-1)
  - [Current Problems](#current-problems)
  - [New Design](#new-design)
  - [Changes](#changes)
  - [EventBus Interface](#eventbus-interface)
  - [Update Steps Phase 1](#update-steps-phase-1)
- [Phase 2: GameState Rewrite](#phase-2-gamestate-rewrite)
  - [Tracker](#tracker-2)
  - [Sub-Phase 2A: Core Loop (Round/Turn/Shinsu)](#sub-phase-2a-core-loop-roundturnshinsu)
  - [Sub-Phase 2B: Unit Deployment \& Field](#sub-phase-2b-unit-deployment--field)
  - [Sub-Phase 2C: Card Types](#sub-phase-2c-card-types)
  - [Sub-Phase 2D: Traits \& Conditions](#sub-phase-2d-traits--conditions)
  - [Sub-Phase 2E: Attributes](#sub-phase-2e-attributes)
  - [File: `server/game/GameState.js` — Comprehensive Rewrite](#file-servergamegamestatejs--comprehensive-rewrite)
  - [GameState Method Inventory (complete)](#gamestate-method-inventory-complete)
  - [Tests for Phase 2](#tests-for-phase-2)
- [Phase 3: Action System Overhaul](#phase-3-action-system-overhaul)
  - [Tracker](#tracker-3)
  - [Current Action Registry](#current-action-registry)
  - [Required Actions](#required-actions)
  - [UseAbilityAction Rewrite](#useabilityaction-rewrite)
  - [New Actions Detail](#new-actions-detail)
  - [Update Steps Phase 3](#update-steps-phase-3)
  - [Tests for Phase 3](#tests-for-phase-3)
- [Phase 4: Ability \& Passive System (Scalable Complexity)](#phase-4-ability--passive-system-scalable-complexity)
  - [Tracker](#tracker-4)
  - [Current Implementation](#current-implementation)
  - [New Architecture](#new-architecture)
  - [Update Steps Phase 4](#update-steps-phase-4)
  - [Passive Complexity Examples (to test the system)](#passive-complexity-examples-to-test-the-system)
  - [Tests for Phase 4](#tests-for-phase-4)
- [Phase 5: Testing Overhaul \& Integration](#phase-5-testing-overhaul--integration)
  - [Tracker](#tracker-5)
  - [Test Structure](#test-structure)
  - [Update Steps Phase 5](#update-steps-phase-5)
  - [What to Test](#what-to-test)
  - [Test Utilities (expand `utils.js`)](#test-utilities-expand-utilsjs)
  - [Test Configuration](#test-configuration)
- [Phase 6: WebSocket \& Client Updates](#phase-6-websocket--client-updates)
  - [Tracker](#tracker-6)
  - [WebSocket Layer (`server/game/websocket.js`)](#websocket-layer-servergamewebsocketjs)
  - [Update Steps Phase 6](#update-steps-phase-6)
  - [Changes Summary](#changes-summary)
- [Implementation Order \& Dependencies](#implementation-order--dependencies)
- [Files to Keep (No Changes Needed)](#files-to-keep-no-changes-needed)
- [Files to Delete (No Longer Needed)](#files-to-delete-no-longer-needed)
...
| `server/data/traits.json`             | **REWRITTEN**                       | Removed all 11 conditions (moved to conditions.json). Added `vengeful`. Verified all 16 traits match RULES.md. Added `color`, `colorName`, `iconPath` fields mirroring conditions.json structure                                                                                        |
