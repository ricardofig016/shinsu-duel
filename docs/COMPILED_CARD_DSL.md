...
`equip`, `slay`, `deploy`, `given`, `kill`, `ally_dies`, `enemy_dies`, `damaged_by`, `round_start`, `round_end`, `deal_damage`, `ability_used`, `summon`, `draw`, `reclaim`, `free_ability_played`, `quick_ability_used`, `activation`, `skill_played`, `skills_played`, `dies`, `evolve`, `has_all_equipped`.
